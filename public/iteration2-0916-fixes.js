(function(){
  ...
  function addEmergencyShortcuts(){
    document.querySelectorAll('header').forEach(function(header){
      ...
      a.className='i2-mobile-emergency-shortcut md:hidden inline-flex items-center justify-center w-10 h-10 rounded-full bg-rose-600 hover:bg-rose-700 transition-colors text-white shrink-0';
      ...
      var menuToggle=row.querySelector('[id$="__mobileNavToggle"]');
      var controls=menuToggle&&menuToggle.parentElement;
      if(controls)controls.appendChild(a);else row.appendChild(a);
    });
  }
