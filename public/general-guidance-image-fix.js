(function () {
  ...
  var IMAGE_URL = 'https://raw.githubusercontent.com/myee0021-beep/5120_tm01_project/main/public/assets/general-guidance-wildlife.jpg?v=20260914-2';
  ...
  function patchEmergencyFrame() {
    ...
    try {
      ...
      if (!frame.__generalImageObserver && doc.body) {
        frame.__generalImageObserver = new MutationObserver(function () {
          setTimeout(function(){ patchDoc(doc, win); }, 0);
        });
      ...
      if (!frame.__generalImageClickHook && doc) {
        doc.addEventListener('click', function(){
          setTimeout(function(){ patchDoc(doc, win); }, 0);
          setTimeout(function(){ patchDoc(doc, win); }, 80);
        }, true);
        frame.__generalImageClickHook = true;
      }
    } catch (e) {
      console.warn('[general-guidance-image-fix] iframe patch failed', e);
    }
  }
