...
export default {
  async fetch(request, env, ctx) {
    ...
    updatedHtml = updatedHtml.replace(
      /<\/body>/i,
      '<script src="/iteration1-fixes.js"></script><script src="/bilingual-fallback.js"></script><script src="/provenance-links.js"></script><script src="/hide-prevention-source-summary.js"></script></body>'
    );
