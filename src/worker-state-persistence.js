...
<script src="/emergency-flow-ac.js?v=20260915-1"></script>
<script src="/emergency-describe-ai.js?v=20260915-1"></script>
...
export default{
  async fetch(request,env,ctx){
    ...
    if(request.method==='GET'&&SPA_ROUTES.has(url.pathname)&&url.pathname!=='/index.html'){
      ...
      upstreamRequest=new Request(rewritten.toString(),request);
    }
